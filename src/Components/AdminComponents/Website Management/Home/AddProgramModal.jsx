...
const AddProgramModal = ({
  ...
  const selectStyle =
    "w-full appearance-none rounded-lg border border-[#cfcfcf] bg-white px-3 py-2 pr-7 font-[Poppins] text-[9px] sm:text-2xs text-[#777777] outline-none focus:border-lime-green";
