...
const ParentsToolbar = ({ searchValue, onSearchChange, onSearch }) => {
  return (
    <div className="flex w-full flex-col gap-2 py-1 md:h-11 md:flex-row md:items-center md:justify-between md:gap-0">
      <div className="flex items-center gap-2">
        <h2 className="font-[PoppinsBold] text-md text-swamp-green">Parents</h2>
      </div>
